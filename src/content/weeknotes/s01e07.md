...
summary: Talks about wearing too many hats at work, running a project point of departure workshop and various small work updates.
---
...
However putting all that aside. I love being able to use my experience and this time it was 'needs must', so I picked up my service design hat and attempted to brush some of the rust off it.

The reason I needed to step in was due to our current service designer leaving for their next contract.

I took it as a compliment when they nominated me to pick up the design and facilitation of a remote kick-off workshop between Policy colleagues, my team and planning experts from various Local Authorities.
...
After some hiccups with people getting access to the board. It worked quite well. I used the lovely timer facility to keep things on track which helped a lot when trying to balance between giving people thinking time as well as contribution time.
