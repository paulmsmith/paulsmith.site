...
summary: A design heavy week sketching and prototyping new data provider pages, wrangling Figma admin and reflecting on how I run crit sessions.
---
...
- We discussed the page, what user-needs it is trying to meet and iterated the prototype as we spoke.
  ...
  I will hopefully get a chance to work with a user researcher to devise a way to test this page and the journey we *think* it is part of.
