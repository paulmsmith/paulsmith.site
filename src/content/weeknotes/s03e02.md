...
summary: Covers building a planning data prototype, running a Design System Day workshop, growing a design community and finally running a postponed 10K.
---
...
- I created a Sharepoint site (shudder) within the department's Office 365 account for the User Centred Community that [Annie Crabtree](https://twitter.com/thisisacrab) and myself have been organising and facilitating.
...
- Finally on Sunday I ran the [Bury 10K event](https://www.runforall.com/events/10k/bury-10k/) event which had been postponed three times because of Covid and the death of her majesty the queen.

  {% imgr { imagePath: 'content/b10k1.jpeg', lazyload: true, width: '640', height: '640', alt: 'Me running in a the finish line with a crowd behind me.' } %}

  {% imgr { imagePath: 'content/b10k2.jpeg', lazyload: true, width: '640', height: '426', alt: 'Me running towards the camera with a tired look on my face, attempting two thumbs up.' } %}
...
I gave a presentation case study about how myself and the team I worked with at Well Pharamcy spent a lot of time carefully convincing and selling stakeholders on the often overlooked value of service and user experience design (including the use of a design system).
...
Knowing it was rushed, not rehearsed and no opportunity to get feedback about it. I felt like I was flying blind.

During my talk, internally I was so intensely panicked that I suffered globus pharyngeus (I think) and had to fight to be able to speak.
