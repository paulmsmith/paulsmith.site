...
summary: First week of 2023 reflecting on resolutions, illness, long running prototype doubts, leadership meetings and a Figma resource being listed on GOVUK.
---
...
- ### Figma resource is listed on GOVUK Design System 🚀
  ...
  This week I submitted [a pull request](https://github.com/alphagov/govuk-design-system/pull/2516) to the design system documentation site for a link to it to be added to the community [resources and tools page](https://design-system.service.gov.uk/community/resources-and-tools/). Which was merged! 🥳
...
- [Keeping npm dependencies up to date and secure](https://eleanormollett.com/posts/2023-01-07---npm-dependencies) - from that clever-clogs again, Eleanor Mollett.
