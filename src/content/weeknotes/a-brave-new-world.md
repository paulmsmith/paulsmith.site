---
title: The treadmill got faster
...
* My squad within [111 Online](https://111.nhs.uk/) has been given the opportunity to work on a long-standing problem that may be unlocked using AI and large language models. It has already shown me that I have a lot of reading to do.

* People are beginning to announce that they have taken voluntary redundancy from NHS England as part of the [planned merger](https://www.instituteforgovernment.org.uk/comment/keir-starmers-abolish-nhs-england) with the Department of Health and Social Care. Some very good people won’t be in my team within weeks. Sigh.
...
* [**I built an AI Service Mapping Tool**](https://sarah-drummond.com/2026/03/i-built-an-ai-service-mapping-tool/) – Sarah explores using AI to build creative tools and reflects on how design has operated in recent years.  
* [**AI and the human voice**](https://gilest.org/notes/2026/human-ai/) – Giles on writing with AI.  
* [**./missing-semester**](https://missing.csail.mit.edu/) – A lovely online course teaching “computing ecosystem literacy”.  
* [**BuzzFeed goes AI then goes broke**](https://pivot-to-ai.com/2026/03/26/buzzfeed-goes-ai-then-it-goes-broke/) – “Peretti is clearly unable to tell good writing from slop, and he’s sure you can’t either”.
